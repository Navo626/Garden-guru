                            ...
                            <form action="../processes/adminEditProcess.php" method="post">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="firstname" class="form-control" value="<?php echo $admin->getFirstName(); ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="lastname" class="form-control" value="<?php echo $admin->getLastName(); ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="email" class="form-control" value="<?php echo $admin->getEmail(); ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="phone" class="form-control" value="<?php echo $admin->getAdminPhoneNo(); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="NIC" class="form-control" value="<?php echo $admin->getAdminNIC(); ?>">
                                    </div>
                                </div>
                                <div class="row ">
                                    <div class="col-sm-6">
